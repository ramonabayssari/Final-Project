...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO admins (admin_name, admin_email, admin_pass) VALUES (?, ?, ?)";
...
<head>
    <meta charset="UTF-8">
    <title>Sign Up</title>
    <con rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <style>
